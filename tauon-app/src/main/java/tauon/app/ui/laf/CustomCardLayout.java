 ...
 * The {@link java.awt.CardLayout#addLayoutComponent}
...
public class CustomCardLayout implements LayoutManager2 {
     ...
     */
    public CustomCardLayout(int hgap, int vgap) {
        this.hgap = hgap;
        this.vgap = vgap;
    }
