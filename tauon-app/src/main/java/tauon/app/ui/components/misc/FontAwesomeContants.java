...
public interface FontAwesomeContants {
    String FA_INFO_CIRCLE = "\uf05a", FA_CUBE = "\uf1b2", FA_FOLDER = "\uf07b", FA_PENCIL_SQUARE_O = "\uf044", FA_BARS = "\uf0c9",
            ...
            FA_STEP_BACKWARD = "\uf048", FA_ANGLE_DOWN = "\uf107", FA_ANGLE_UP = "\uf106", FA_FAST_BACKWARD = "\uf049",
            FA_FAST_FORWARD = "\uf050", FA_UNDO = "\uf0e2", FA_BRIEFCASE = "\uf0b1", FA_PIE_CHART = "\uf200",
            FA_STICKY_NOTE = "\uf249", FA_COGS = "\uf085", FA_LINUX = "\uf17c", FA_AREA_CHART = "\uf1fe",
            FA_KEY = "\uf084", FA_WRENCH = "\uf0ad", FA_SERVER = "\uf233", FA_DATABASE = "\uf1c0", FA_EJECT = "\uf052",
            FA_QUESTION_CIRCLE = "\uf059", FA_REFRESH = "\uf021", FA_TOGGLE_ON = "\uf205", FA_TOGGLE_OFF = "\uf204",
            FA_CLOUD_UPLOAD = "\uf0ee", FA_CLOUD_DOWNLOAD = "\uf0ed", FA_PLUS = "\uf067", FA_MINUS = "\uf068",
            ...
            FA_TRASH = "\uf1f8", FA_RECTANGLE_LIST = "\uf022", FA_ARROW_RIGHT_ARROW_LEFT = "\uf0ec";
}
