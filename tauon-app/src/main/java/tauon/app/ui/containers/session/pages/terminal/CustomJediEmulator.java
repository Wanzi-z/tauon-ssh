...
public class CustomJediEmulator extends JediEmulator {
    private static final Logger LOG = LoggerFactory.getLogger(CustomJediEmulator.class);
    ...
    public CustomJediEmulator(TerminalDataStream dataStream, Terminal terminal) {
    ...
    public static void copyToAllClipboards(String text) {
        ...
        try {
            ...
            Method m = tk.getClass().getMethod("getSystemSelection");
...
//        height or width.
    ...
    public static class ControlSequence{
